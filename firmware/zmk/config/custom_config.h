...
U_NA,          &kp KP_N7,       &kp KP_N8,       &kp KP_N9,      U_NA,              U_RGB_TOG,         U_RGB_EFF,         U_RGB_HUI,         U_RGB_SAI,         U_RGB_BRI,         \
U_NA,          &kp KP_N4,       &kp KP_N5,       &kp KP_N6,      U_NA,              U_EP_TOG,          &kp C_PREV,        &kp C_VOL_DN,      &kp C_VOL_UP,      &kp C_NEXT,        \
