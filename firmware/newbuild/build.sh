...
west build -s zmk/app -p -b nice_nano_v2 -- -DSHIELD="clavis_left" -DZMK_CONFIG="${PWD}/config"
cp build/zephyr/zmk.uf2 "./firmware/${TIMESTAMP}_left.uf2"

west build -s zmk/app -p -b nice_nano_v2 -- -DSHIELD="clavis_right" -DZMK_CONFIG="${PWD}/config"
